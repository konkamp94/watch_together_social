...
const FriendshipActionButton = ({ otherUserId, friendshipInfo }: {otherUserId: number, friendshipInfo: FriendshipInfo | null}) => {
    ...
    const { addFriend, errorMessageAddFriend, isLoadingAddFriend, } = useAddFriend((friendshipInfo) => { 
        setFriendshipInfoState(friendshipInfo)
    })
    const { acceptOrRejectFriend, errorMessageAcceptOrReject, isLoadingAcceptOrReject } 
